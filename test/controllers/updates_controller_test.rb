...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { display_text: @update.display_text, email: @update.email, participant_name: @update.participant_name }
    end
  ...
  test "should update update" do
    patch :update, id: @update, update: { display_text: @update.display_text, email: @update.email, participant_name: @update.participant_name }
    assert_redirected_to update_path(assigns(:update))
  end
